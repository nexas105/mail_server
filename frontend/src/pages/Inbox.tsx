...
export function Inbox() {
  ...
  async function open(m: Message) {
    setOpenId(m.id); setDetail(null); setDetail(await api<Message>('/messages/' + m.id));
